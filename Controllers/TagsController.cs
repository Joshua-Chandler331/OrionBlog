...
namespace OrionBlog.Controllers
{
    public class TagsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Created,Updated")] Tag tag)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Created,Updated")] Tag tag)
        {
            if (id != tag.Id)
            {
                return NotFound();
