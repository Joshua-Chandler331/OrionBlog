...
namespace OrionBlog.Controllers
{
    public class PostCommentsController : Controller
    {
        ...
        {
            ViewData["BlogUserId"] = new SelectList(_context.Users, "Id", "Name");
            ViewData["CategoryPostId"] = new SelectList(_context.CategoryPost, "Id", "BlogCatagoryId.Name");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,CategoryPostId,BlogUserId,CommentBody,Created,Updated,Moderated,ModeratedReason,ModeratedBody")] PostComment postComment)
        {
            if (ModelState.IsValid)
            {
                var dateTime = DateTime.Now; //Added
                postComment.Created = DateTime.Now; //Added
                var dateTime2 = DateTime.Now;
                postComment.Updated = DateTime.Now; //Added
                _context.Add(postComment);
                await _context.SaveChangesAsync();
                return RedirectToAction(nameof(Index));
            }
            ViewData["BlogUserId"] = new SelectList(_context.Users, "Id", "Id", postComment.BlogUserId);
            ViewData["CategoryPostId"] = new SelectList(_context.CategoryPost, "Id", "BlogCatagoryId.Name", postComment.CategoryPostId);
            return View(postComment);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CategoryPostId,BlogUserId,CommentBody,Created,Updated,Moderated,ModeratedReason,ModeratedBody")] PostComment postComment)
        {
